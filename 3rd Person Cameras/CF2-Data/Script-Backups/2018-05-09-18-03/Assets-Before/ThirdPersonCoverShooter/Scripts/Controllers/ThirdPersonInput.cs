...
namespace CoverShooter
{
    ...
    public class ThirdPersonInput : MonoBehaviour
    {
        ...
        protected virtual void UpdateMovement()
        {
            ...
            var direction = CrossPlatformInputManager.GetAxis("Horizontal") * Vector3.right +
                            CrossPlatformInputManager.GetAxis("Vertical") * Vector3.forward;
        ...
        {
            if (CrossPlatformInputManager.GetButtonDown("TakeCover"))
        ...
        protected virtual void UpdateGrenade()
        {
            if (_motor.HasGrenadeInHand)
            {
                ...
                if (!_motor.IsReadyToThrowGrenade)
                    if (CrossPlatformInputManager.GetButton("Grenade"))
        ...
        {
            if (CrossPlatformInputManager.GetButtonDown("Fire1")) _controller.FireInput = true;
            if (CrossPlatformInputManager.GetButtonDown("Fire2")) _controller.ZoomInput = true;
            if (CrossPlatformInputManager.GetButtonUp("Fire1")) _controller.FireInput = false;
            if (CrossPlatformInputManager.GetButtonUp("Fire2")) _controller.ZoomInput = false;
        }
        ...
        protected virtual void UpdateRolling()
        {
            ...
            if (CrossPlatformInputManager.GetButtonDown("RollLeft"))
            {
            ...
            if (CrossPlatformInputManager.GetButtonDown("RollBackward"))
            {
            ...
            if (CrossPlatformInputManager.GetButtonDown("RollRight"))
            {
        ...
        protected virtual void UpdateCamera()
        {
            ...
            Debug.LogError(CrossPlatformInputManager.GetAxis("Mouse X") + CrossPlatformInputManager.GetAxis("Mouse Y"));
                camera.Horizontal = Mathf.LerpAngle(camera.Horizontal, camera.Horizontal + CrossPlatformInputManager.GetAxis("Mouse X") * HorizontalRotateSpeed * Time.timeScale * scale, Time.deltaTime);
                camera.Vertical = Mathf.LerpAngle(camera.Vertical, camera.Vertical - CrossPlatformInputManager.GetAxis("Mouse Y") * VerticalRotateSpeed * Time.timeScale * scale, Time.deltaTime);
