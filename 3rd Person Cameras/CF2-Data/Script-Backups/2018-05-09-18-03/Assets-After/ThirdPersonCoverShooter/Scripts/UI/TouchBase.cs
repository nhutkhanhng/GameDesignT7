...
namespace CoverShooter
{
    ...
    public abstract class TouchBase : MonoBehaviour, IPointerDownHandler
    {
        ...
        protected virtual void Update()
        {
            ...
            var mouseDelta = new Vector2(ControlFreak2.CF2Input.mousePosition.x, ControlFreak2.CF2Input.mousePosition.y) - _previousMousePosition;
            _previousMousePosition = ControlFreak2.CF2Input.mousePosition;

            var wasMouseDown = _previousMouseDown;
            _previousMouseDown = ControlFreak2.CF2Input.GetMouseButton(0);
            ...
            if (Application.isMobilePlatform)
            {
                ...
                {
                    var touch = ControlFreak2.CF2Input.GetTouch(i);
            ...
            {
                var mouse = new Vector2(ControlFreak2.CF2Input.mousePosition.x, ControlFreak2.CF2Input.mousePosition.y);
